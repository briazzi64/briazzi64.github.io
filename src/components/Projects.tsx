    ...
    <Box className="projects-container" id="projects">
      ...
      <Box className="projects-grid">
        <ProjectCard
          ...
          description="I built and managed the React Native mobile banking app. This includes creating and managing the CI/CD pipeline for deploying the mobile app to the App Store/Play Store, tracking post-deployment bug reports to recognize and resolve trends among user-reported faults and complaints and implementing E2E tests using Maestro. I built and managed the React web application for managing the advisor's banking clients and implemented E2E tests using Playwright."
        />
        <ProjectCard
          imgSrc={smartlink}
          link="https://www.gojo.com/en/Product-Catalog/Dispenser/Smartlink"
          title="Purell SmartLink"
          description="I managed the architecture of the Vue application that displayed a graphs and charts for Purell that tracks employee hand hygiene and washing percentages. I implemented analytics solutions to track user engagement and problem points to help drive design decisions."
        />
        <ProjectCard
          imgSrc={ws}
          link={
          ...
          description="I helped create 'Find a Store Near You' and 'Buy Online Pickup In Store' functionality for Williams Sonoma Inc and all its affiliated brands and I assisted in the E2E testing using Playwright."
        />
        <ProjectCard
          imgSrc={vs}
